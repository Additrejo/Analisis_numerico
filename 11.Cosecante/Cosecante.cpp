...
Programa: 11. Grafica de una cosecante.
Creado Diciembre 2018 
Descripcion: Graficar una funcion cosecante.
----------------------------------------------------------------------------------------------------------
*/
#include <graphics.h>
#include <math.h>
...
/*****************************************************************************************************************************/  
void dibujarCosecante ( ){
	float x, y;
	for ( x = -360 ; x <= 360; x += 0.01 ) {
		// Amplitud                            Tamaño de las ondas
		y = 90 *( 1 /  sin ( 2 * M_PI * ( float ) x / 240) );
...
int main() {
	...
	cout<<"\t\t\t\t\tPrograma: Grafica de una funcion cosecante\n"<<endl;
	printf("-----------------------------------------------------------------------------------------------------------------------\n");
	
	cout << " Grafica de la funcion cosecante" << endl;
	pintarPlano();
	dibujarCosecante();
	getch();
	closegraph();

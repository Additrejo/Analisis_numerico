...
Programa: 10.Grafica de la funcion secante
Creado Diciembre 2018
Descripcion: Graficar una funcion secante
----------------------------------------------------------------------------------------------------------
...
int main() {
	...
	cout<<"\t\t\t\t\tPrograma: Grafica de una funcion secante\n"<<endl;
	printf("-----------------------------------------------------------------------------------------------------------------------\n");
	
	cout << " Grafica de la funcion secante" << endl;
	pintarPlano();
	dibujarSecante();
	getch();
	closegraph();

...
Programa: 09. Grafica de una cotangente
Creado Diciembre 2018 
Descripcion: Graficar una funcion cotangente.
----------------------------------------------------------------------------------------------------------
*/
#include <graphics.h>
#include <math.h>
...
/*****************************************************************************************************************************/  
void dibujarCotangente ( ){
	float x, y;
	for ( x = -360; x <= 360; x += 0.01 ) {
		y = - 90 * tan ( 2 * M_PI * ( float ) x / 240) ;
...
int main() {
	...
	cout<<"\t\t\t\t\tPrograma: Grafica de una funcion cotangente\n"<<endl;
	printf("-----------------------------------------------------------------------------------------------------------------------\n");
	
	cout << " Grafica de la funcion Tangente" << endl;
	pintarPlano();
	dibujarCotangente();
	getch();
	closegraph();

...
Programa: 14. Grafica de la funcion valor absoluto
Creado Diciembre 2018 
Descripcion: Graficar una funcion valor absoluto
----------------------------------------------------------------------------------------------------------
*/
#include <graphics.h>
#include <math.h>
...
int main() {
	...
	cout<<"\t\t\t\t\tPrograma: Grafica de una funcion valor absoluto\n"<<endl;
	printf("-----------------------------------------------------------------------------------------------------------------------\n");
	
	cout << " Grafica de la funcion Valor Absoluto "<< endl;
	pintarPlano();
	dibujarValAbsoluto();
	getch();
	closegraph();
